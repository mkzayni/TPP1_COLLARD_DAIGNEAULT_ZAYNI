...
class GradientMoindresCarres:
    def __init__(self, case, phi, dphi_analytical):
        ...
        self.phi = phi                   # Équation du champ pour calculer les valeurs aux centres des volumes
        self.dphi_function = dphi_analytical  # Fonction analytical du gradient

    # Calcule les distances dx et dy entre les centres des éléments d'une arête
    def compute_distances(self, i_face):
        ...
        for i in range(len(nodes[0])):
            ...
            x, y = self.mesh_obj.get_node_to_xycoord(i_nodes_left)[0], self.mesh_obj.get_node_to_xycoord(i_nodes_left)[1]
